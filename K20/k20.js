...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'k20.data';
    var REMOTE_PACKAGE_BASE = 'k20.data';
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_k20.data');

    };
    Module['addRunDependency']('datafile_k20.data');
...
Module.print = (function() {
    ...
    return function(text) {
        ...
        if (text.indexOf('C++') != -1) {
            setStatus('Generator loaded into memory.');
        }
        console.log(text);
    };
})();
...
$.fn.customFile = function() {
    ...
    return this.each(function() {
        ...
        let text = $(this).data("text"),
            ...
            $button = $('<button type="button" class="file-upload-button">' + text + '</button>'),
            // Hack for IE
            $label = $('<label class="file-upload-button" for="' + $file[0].id + '">' + text + '</label>');
        ...
        $file.change(function() {
            ...
            let idx = $("input[type=file]").index($file);
            let reader = new FileReader();
            reader.onload = function(e) {
                let imgData = e.target.result;
                let imgName = $file[0].files[0].name;
                // window.str = btoa(imgData);
                imgName = Math.round(Math.random() * 100) + imgName;
            ...
            if($file[0].files.length) reader.readAsBinaryString($file[0].files[0]);
            	...
            	ccall('setImage', 'number', ['number', 'string'], [idx, '']);
            	setStatus('Set to default image.');
            }
        });
...
$('button#submit-button').click(function(){
	setStatus('Generating logo partition...');
	setTimeout(function(){
		ccall('buildLogo', 'number', [], []);
		setStatus('Downloading...');
		saveFileFromMemoryFSToDisk("logo.img", "custom_logo.img");
		setTimeout(function(){
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 22688,
    DYNAMIC_BASE = 5265568,
    DYNAMICTOP_PTR = 22528;
...
var INITIAL_TOTAL_MEMORY = Module['TOTAL_MEMORY'] || 1342177280;if (!Object.getOwnPropertyDescriptor(Module, 'TOTAL_MEMORY')) Object.defineProperty(Module, 'TOTAL_MEMORY', { configurable: true, get: function() { abort('Module.TOTAL_MEMORY has been replaced with plain INITIAL_TOTAL_MEMORY') } });
...
var real__buildLogo = asm["buildLogo"];
asm["buildLogo"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
...
asm["setImage"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__setImage.apply(null, arguments);
};
...
var _buildLogo = Module["_buildLogo"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
...
var _setImage = Module["_setImage"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["setImage"].apply(null, arguments)
};
